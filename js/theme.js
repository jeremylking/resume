(function () {
  ...
  // Bootstrap Icons (sun-fill, moon-fill, stars) inlined so they can use
  // fill="currentColor" and pick up the surrounding text color per theme.
  var ICONS = {
  ...
  function updateIcon(preference) {
    ...
    if (icon) icon.innerHTML = ICONS[preference] || ICONS.auto;
  }
